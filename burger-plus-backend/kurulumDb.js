      ...
      const sonuc = await baglanti.query(
        `INSERT INTO urunler
          (isletme_id,ad,fiyat,kategori,gorsel,aciklama,malzemeler,alerjenler,besin_degerleri,
           temel_miktar,gramaj_opsiyonu,urun_tipi,boyut_secenekleri,populer,aktif,arsivli)
         VALUES ($1,$2,$3,$4,$5,$6,$7::jsonb,$8::jsonb,$9::jsonb,$10,$11::jsonb,$12,$13::jsonb,$14,true,false)
         RETURNING id`,
